// Текущая версия : FieryLedLamp v3.7_new_web 122 эффекта
...
#define LED_PIN               (4U)                          // пин ленты (4U) = D2               (D3) на (D4) - встроенный светодиод платы , поэтому лучше паять на D3 = #define LED_PIN (0U)
#define BTN_PIN               (12U)                         // пин кнопки  (12U) = D6             (D2)
